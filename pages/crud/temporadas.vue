  <template>
    <div class="contenedor-principal">
      ...
      <div class="tabla-contenedor">
        <table v-if="temporadas.length" class="inventarios-table">
          <thead>
            <tr>
              <th>ID Temporada</th>
              <th>Temporada</th>
  ...
  export default {
    ...
    methods: {
      ...
      cerrarModalDetalle() {
        ...
        this.nuevoDetalle = { idTemporada: null, idProducto: null };
      },
      ...
      async actualizarDetalleTemporada() {
        try {
          await axios.put(
            `http://localhost:5000/detalletemp/update/${this.detalleSeleccionado.idDetalleTemporada}`,
            this.detalleSeleccionado
          );
          this.obtenerDetallesTemporada();
      ...
      async desactivarDetalleTemporada(inventario) {
          try {
            inventario.estado = 0;
            await axios.put(`http://localhost:5000/detalletemp/update/${inventario.idInventario}`, inventario);
